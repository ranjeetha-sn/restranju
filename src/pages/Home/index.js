					...
					<div class="container">
						<div class="row">
							<div class="col-md-7 offset-md-5">
									...
									<p>A design isn't finished until someone is using it
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 mb-30 animate-box" data-animate-effect="fadeInUp">
						<h2 class="section-title">About <span>ART LOOK</span></h2>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="owl-carousel owl-theme">
                            ...
                            <div class="item">
								<div class="position-re o-hidden"> <img src="img/projects/5.jpg" alt=""/> </div>
								<div class="con">
									<h6><a href="prime-hotel.html">Interior</a></h6>
									<h5><a href="prime-hotel.html">Prime Hotel</a></h5>
									<div class="line"></div> <a href="prime-hotel.html"><i class="ti-arrow-right"></i></a>
                            ...
                            <div class="item">
								<div class="position-re o-hidden"> <img src="img/projects/6.jpg" alt=""/> </div>
								<div class="con">
									<h6><a href="prime-hotel.html">Interior</a></h6>
									<h5><a href="prime-hotel.html">Prime Hotel</a></h5>
									<div class="line"></div> <a href="prime-hotel.html"><i class="ti-arrow-right"></i></a>
                            ...
                            <div class="item">
								<div class="position-re o-hidden"> <img src="img/projects/7.jpg" alt=""/> </div>
								<div class="con">
									<h6><a href="prime-hotel.html">Interior</a></h6>
									<h5><a href="prime-hotel.html">Prime Hotel</a></h5>
									<div class="line"></div> <a href="prime-hotel.html"><i class="ti-arrow-right"></i></a>
                            ...
                            <div class="item">
								<div class="position-re o-hidden"> <img src="img/projects/8.jpg" alt=""/> </div>
								<div class="con">
									<h6><a href="prime-hotel.html">Interior</a></h6>
									<h5><a href="prime-hotel.html">Prime Hotel</a></h5>
									<div class="line"></div> <a href="prime-hotel.html"><i class="ti-arrow-right"></i></a>
                            ...
                            <div class="item">
								<div class="position-re o-hidden"> <img src="img/projects/9.jpg" alt=""/> </div>
								<div class="con">
									<h6><a href="prime-hotel.html">Interior</a></h6>
									<h5><a href="prime-hotel.html">Prime Hotel</a></h5>
									<div class="line"></div> <a href="prime-hotel.html"><i class="ti-arrow-right"></i></a>
		...
		<section class="services section-padding">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="item">
							<a href="architecture.html"> <img src="img/icons/murals.png" alt=""/>
								<h5>MURALS</h5>
								<div class="line"></div>
					...
					<div class="col-md-4">
						<div class="item">
							<a href="interior-design.html"> <img src="img/icons/sculpture.png" alt=""/>
								<h5>3D SCULPTURES</h5>
								<div class="line"></div>
								<p>Architecture bibendum eros eget lacus the vulputate sit amet vehicuta nibhen ulicera in the vitae miss.</p>
					...
					<div class="col-md-4">
						<div class="item">
							<a href="urban-design.html"> <img src="img/icons/fountains.png" alt=""/>
								<h5>FOUNTAINS</h5>
								<div class="line"></div>
								<p>Architecture bibendum eros eget lacus the vulputate sit amet vehicuta nibhen ulicera in the vitae miss.</p>
                ...
                <div class="row">
					<div class="col-md-4">
						<div class="item">
							<a href="architecture.html"> <img src="img/icons/planterbox.png" alt=""/>
					...
					<div class="col-md-4">
						<div class="item">
							<a href="interior-design.html"> <img src="img/icons/seater.png" alt=""/>
					...
					<div class="col-md-4">
						<div class="item">
							<a href="urban-design.html"> <img src="img/icons/canvas.png" alt=""/>
                ...
                <div class="row">
					<div class="col-md-4">
						<div class="item">
							<a href="architecture.html"> <img src="img/icons/ddoors.png" alt=""/>
								<h5>BRASS DOORS</h5>
								<div class="line"></div>
								<p>Architecture bibendum eros eget lacus the vulputate sit amet vehicuta nibhen ulicera in the vitae miss.</p>
					...
					<div class="col-md-4">
						<div class="item">
							<a href="interior-design.html"> <img src="img/icons/wall.png" alt=""/>
					...
					<div class="col-md-4">
						<div class="item">
							<a href="urban-design.html"> <img src="img/icons/la.png" alt=""/>
								<h5>LANDSCAPING</h5>
								<div class="line"></div>
								<p>Architecture bibendum eros eget lacus the vulputate sit amet vehicuta nibhen ulicera in the vitae miss.</p>
